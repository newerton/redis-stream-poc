...
@Module({
  providers: [
    { provide: REDIS_STREAMS_CLIENT_PROXY, useClass: RedisStreamClient },
  ],
  exports: [
    { provide: REDIS_STREAMS_CLIENT_PROXY, useExisting: RedisStreamClient },
  ],
})
